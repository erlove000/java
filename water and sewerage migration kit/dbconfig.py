...
implementation_url="https://mseva.lgpunjab.gov.in"


#-------------------------- Empployee Login Detail------------------------

Employee_username="EMP-NANGAL-MIGRATOR"
Employee_password="Block$1234@"
Employee_tenatid="pb.nangal"
...
def login_egov(username, password, tenant_id, user_type="EMPLOYEE"):
    url = "https://mseva.lgpunjab.gov.in/user/oauth/token"
    ...
    headers = {
        ...
        'origin': 'https://mseva.lgpunjab.gov.in',
        'priority': 'u=1, i',
...
dbname = os.getenv("DB_NAME", "Nangal")
dbuser = os.getenv("DB_USER", "postgres")
dbpassword = os.getenv("DB_PASSWORD", "postgres")

host = os.getenv("DB_HOST", "localhost")
batch = os.getenv("BATCH_NAME", "2")
table_name = os.getenv("TABLE_NAME", "nangal_migrate_records_prod")
