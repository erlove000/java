...
cur.execute("SELECT row_to_json(cd) FROM meter_billing AS cd where isdead='TRUE' and islocked='FALSE' and prev_rdg is not null and response_code is null and prev_rdg = '0.0' limit 500 offset 500;")
