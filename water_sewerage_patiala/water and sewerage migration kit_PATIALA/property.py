...
db = psycopg2.connect(
    ...
    dbname="PatialaData"  # Update this if needed
)

cursor = db.cursor()

# Step 1: Retrieve property IDs where landarea or usagecategory is NULL
cursor.execute("SELECT propertyid FROM propertydata_prod WHERE landarea IS NULL OR usagecategory IS NULL limit 2000 offset 0")
property_ids = cursor.fetchall()

# Define the base API URL
base_api_url = "https://mseva.lgpunjab.gov.in/property-services/property/_search?tenantId=pb.patiala&propertyIds="
...
json_body = {
    "RequestInfo": {
        ...
        "requesterId": "",
        "authToken": "d52d9cc8-2b58-4409-aa20-3fa37182bebd",
        "userInfo": {
            "id": 1296680,
            ...
            "tenantId": "pb.patiala",
            "roles": [
                {"code": "SW_APPROVER", "name": "SW Approver", "tenantId": "pb.patiala"},
                {"code": "PT_REC_CANCEL", "name": "PT Receipt Cancellation", "tenantId": "pb.patiala"},
